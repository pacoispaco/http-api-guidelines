...
The REST architectural style has been concieved and the HTTP protocol has been specified with specific intent to support the design and programming of such systems.
