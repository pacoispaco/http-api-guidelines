...
*  We want to design and implement systems that can interact with other systems
   in a distributed network environment. The other systems in this environment
   ...
   differing release and update cycles. We also want to be able to continue to
   develop our system at the same time as the other systems are beeing developed
   whithout impacting the other systems negatively or having our system being
   impacted negatively by changes in the other systems.
